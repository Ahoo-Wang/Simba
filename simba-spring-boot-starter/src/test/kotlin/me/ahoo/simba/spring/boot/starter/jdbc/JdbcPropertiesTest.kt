 ...
 * @author ahoo wang
 */
internal class JdbcPropertiesTest {
    ...
    fun setInitialDelay() {
        ...
        val properties = JdbcProperties(initialDelay = initialDelay)
    ...
    fun setTtl() {
        ...
        val properties = JdbcProperties(ttl = ttl)
    ...
    fun setTransition() {
        ...
        val properties = JdbcProperties(transition = transition)
